...
function CommitteeTitleQueueWidget() {
...
function CommitteeTimelineWidget() {
  return (
    <DashboardSectionCard
...
export const DepartmentCommitteeWidgets = {
  "dc.summary": {
    meta: {
      id: "dc.summary",
      title: "KPIs",
      rolesAllowed: ["department_committee"],
      defaultSize: { w: 12, h: 4 },
      minSize: { w: 6, h: 3 },
    },
    component: CommitteeKpisWidget,
  },
  "dc.assigned": {
    meta: {
      id: "dc.assigned",
    ...
    component: CommitteeTitleQueueWidget,
  },
  "dc.schedule": {
    meta: {
      id: "dc.schedule",
    ...
    component: CommitteeTimelineWidget,
  },
} as const
