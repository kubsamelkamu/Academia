...
import { type DepartmentHeadKpi } from "@/types/dashboard"
import {
  Building2,
  Calendar,
  CheckCircle2,
...
import { DashboardKpiSkeleton, DashboardSectionsSkeleton } from "@/components/dashboard/roles/shared-skeletons"
...
function DepartmentHeadKpisWidget() {
...
function DepartmentHeadUrgentApprovalsWidget() {
  const { data, isLoading } = useDepartmentHeadDashboard()
...
function DepartmentHeadCoordinatorStatusWidget() {
  const { data, isLoading } = useDepartmentHeadDashboard()
              ...
              return (
                <div key={`${row.name}-progress`} className="rounded-lg border p-3">
                  ...
                  <div className="mt-3">
                    ...
                    <p className="mt-2 text-xs text-muted-foreground">{blockedPercent}% blocked</p>
                  </div>
                </div>
              )
            })}
...
function DepartmentHeadUpcomingDefensesWidget() {
  const { data, isLoading } = useDepartmentHeadDashboard()
...
export const DepartmentHeadWidgets = {
  "dh.kpis": {
    meta: {
      id: "dh.kpis",
      title: "KPIs",
      rolesAllowed: ["department_head"],
      defaultSize: { w: 12, h: 3 },
      minSize: { w: 6, h: 3 },
    },
    component: DepartmentHeadKpisWidget,
  },
  "dh.urgent": {
    meta: {
      id: "dh.urgent",
    ...
    component: DepartmentHeadUrgentApprovalsWidget,
  },
  "dh.status": {
    meta: {
      id: "dh.status",
    ...
    component: DepartmentHeadCoordinatorStatusWidget,
  },
  "dh.defenses": {
    meta: {
      id: "dh.defenses",
    ...
    component: DepartmentHeadUpcomingDefensesWidget,
  },
} as const
